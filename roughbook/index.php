...
കെഡിഇ പണിയിടസ്ഥലത്തിനു് വന്ന മെച്ചങ്ങളുടെ ചെറിയ പട്ടിക താഴെ കാണാം.
<ul>
  <li>
    <a href="http://plasma.kde.org">പ്ലാസ്മാ പണിയിട കവചം</a> <b>പുതിയ സഹജ പ്രമേയമായ</b>, എയര്‍ പരിചയപ്പെടുത്തുന്നു. എയര്‍ വളരെ ഭാരം കുറഞ്ഞതും പ്രയോഗങ്ങളുടെ സഹജ പ്രമേയവുമായി നന്നായി യോജിച്ചു് പോകുന്നതുമാണു്. പ്ലാസ്മയില്‍ വലിയ <b>പ്രകടനത്തിലെ മെച്ചങ്ങളും</b> കാണാവുന്നതാണു്. മെമ്മറി ഉപയോഗം കുറയുകയും അനിമേഷന്‍ മൃദുലമാകുകയും ചെയ്തിട്ടുണ്ടു്. ഓരോ പണിയിടത്തിലും വ്യത്യസ്ത ഉരുപ്പടികളാകാവുന്ന വിധത്തില്‍ <b>പരിപാടികള്‍ മായാ പണിയിടവുമായി ഇപ്പോള്‍ ചേര്‍ത്തു വയ്ക്കാവുന്നതാണു്</b>. കൂടുതലായി, സ്വന്തം <b>ജോലിയുടേയും അറിയിപ്പിന്റേയും നടത്തിപ്പു്</b> പ്ലാസ്മ മെച്ചപ്പെടുത്തിയിട്ടുണ്ടു്. വളരെയധികം സന്ദേശങ്ങള്‍ പൊങ്ങി വരുന്നതു് തടയാനായി പ്രവര്‍ത്തിച്ചു് കൊണ്ടിരിയ്ക്കുന്ന ജോലികളെല്ലാം ഒരൊറ്റ പുരോഗതി കാണിയ്ക്കുന്ന പട്ടയിലേയ്ക്കു് ചേര്‍ത്തിരിയ്ക്കുന്നു. വളരെ മൃദുലമായി സന്ദേശങ്ങള്‍ സിസ്റ്റംട്രേയിലേയ്ക്കു് നീക്കിയും അറിയിപ്പിന്റെ ചിഹ്നത്തെ അനിമേറ്റ് ചെയ്തും ജോലികള്‍ ഇപ്പോഴും പ്രവര്‍ത്തിയ്ക്കുന്നുണ്ടെന്നു് പ്രധാന്യത്തോടെ കാണിയ്ക്കുന്നു.  Smaller changes in Plasma include <b>fully configurable keyboard shortcuts</b> and more extensive keyboard navigation, the ability to create a plasma widget when you drag or copy content on the desktop and many <b>new and improved Plasma widgets</b>. The folderview widget now allows the user to <b>peek into a folder by hovering it</b> and the <b>new Translatoid widget</b> translates words and sentences right on your desktop using Google Translate. Furthermore, KRunner made its <b>plugin features easier to discover</b> by having a 'help' button showing the syntax of commands in the result area. <b>Actions also have a small configuration</b> allowing for example to start applications under another user account.<br>
    <br>
    </li>
  <li>
